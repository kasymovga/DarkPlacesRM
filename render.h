...
void R_ResetViewRendering2D_Common(int fbo, rtexture_t *depthtexture, rtexture_t *colortexture, int x, int y, int width, int height, float x2, float y2); // this is called by R_ResetViewRendering2D and _DrawQ_Setup and internal
