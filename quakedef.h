...
#define	MAX_CACHED_PICS			4096 // this is 144 bytes each (or 152 on 64bit)
...
#define	MAX_CACHED_PICS			16384 ///< max number of 2D pics loaded at once
#define	CACHEPICHASHSIZE		1024 ///< number of hash buckets for accelerating 2D pic name lookups
...
#define	MAX_PARTICLES			32768 ///< upper limit on cl.particles size
#define	MAX_DECALS_INITIAL		8192 ///< initial allocation for cl.decals
#define	MAX_DECALS				32768 ///< upper limit on cl.decals size
...
#define	MAX_BEAMS				1024 ///< limit on size of cl.beams
