...
PRVM_DECLARE_clientfunction(curl_event)
...
PRVM_DECLARE_clientglobalvector(mouse_pos)
...
PRVM_DECLARE_clientglobalvector(camera_transform_fov)
...
PRVM_DECLARE_field(culltracemode)
...
PRVM_DECLARE_function(CvarUpdated)
PRVM_DECLARE_function(curl_event)
PRVM_DECLARE_function(perf_event)
...
PRVM_DECLARE_global(camera_transform_fov)
PRVM_DECLARE_global(mouse_pos)
...
PRVM_DECLARE_menufunction(curl_event)
...
PRVM_DECLARE_serverfieldedict(clientdataent)
PRVM_DECLARE_serverfieldedict(existsonlyfor)
...
PRVM_DECLARE_serverfieldfloat(culltracemode)
...
PRVM_DECLARE_serverfunction(curl_event)
PRVM_DECLARE_serverfunction(perf_event)
